<!-- LOGO SEO -->
<meta alt="devmattb" itemprop="image" content="/devmattb.com/img/logo_v2.png">
<meta alt="devmattb" property="og:image" content="/devmattb.com/img/logo_v2.png">
<meta alt="devmattb" name="twitter:image" content="/devmattb.com/img/logo_v2.png">
  ...
  <nav class="black">
    <div class="nav-wrapper white-text">
      <a href="/" style="margin-left: 10px; margin-top: -8px;" class="brand-logo hide-on-med-and-down">
        <img alt="devmattb matt bergstrom" style="width: 140px;" src="../img/logo_white_transparent.png">
      </a>
