INSERT INTO projectPosts (title, subtitle, whatText, whyText, howText, projectCoverImgSrc, demoLink, ongoingProject, createdBy)
VALUES
    (
    "ChipKit Tetris",
  ...
  INSERT INTO casePosts
      (caseTitle, caseText, imgSrc, demoLink)
  VALUES
      (
      "TETRIS SHOWCASE",
      "blablabslbldsaladsf nasdlkf lasbnfkl dsahnfkl ahndsl fkasdhfl kashjlk <br> dfsaklfhlsad <br> asdiofodisaj",
